...
class procesardisc extends PopUp
{
  ...
  function mostrarContenido()
  {
	...
	if($_SESSION['tipo']=='Root' || $_SESSION['tipo']=='Admin')
	{
		...
		if(!$result)
		{
			echo "<h2>¡¡¡ Error !!! no se pudo Agregar los datos</h2>";
		}
		else {
			echo "<h2>La información se ingresó correctamente</h2>

			<a href='index.php'>Volver</a> | <a href='../ver_empleado/disciplinario.php?idu=$_POST[idu]'>Ver historial</a>";
		}
